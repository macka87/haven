--------------------------------------------------------------------
-- Name: rx_dma_ctrl_opt_arch_16b.vhd
...
ENTITY rx_dma_ctrl_opt_arch_16b IS
...
-- this is the top level entity
ARCHITECTURE behaviour OF rx_dma_ctrl_opt_arch_16b IS
component RAM16X1D
        generic (
...
component RAM64X1D
  ...
  -- Plus
  SIGNAL BinOpOut_13 : unsigned(2 DOWNTO 0);
  -- Clock cycle delay
  SIGNAL Z_Dones_2_1 : std_logic;
  -- Constant value
  CONSTANT ConstOut_9 : unsigned(2 DOWNTO 0) := "001";
  -- Plus
  SIGNAL BinOpOut_14 : unsigned(2 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_10 : unsigned(2 DOWNTO 0) := "100";
  ...
  -- Concatenation
  SIGNAL BinOpOut_30 : unsigned(15 DOWNTO 0);
  -- Clock cycle delay
  ...
  -- Constant value
  CONSTANT ConstOut_14 : unsigned(2 DOWNTO 0) := "011";
  -- Clock cycle delay
  SIGNAL SeqChain_2 : std_logic;
  -- Bit range selection
  SIGNAL BinOpOut_33 : unsigned(15 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_15 : unsigned(2 DOWNTO 0) := "010";
  -- Clock cycle delay
  ...
  -- Constant value
  CONSTANT ConstOut_16 : unsigned(3 DOWNTO 0) := "0001";
  -- Concatenation
  SIGNAL BinOpOut_35 : unsigned(15 DOWNTO 0);
  -- Plus
  SIGNAL BinOpOut_36 : unsigned(11 DOWNTO 0);
  -- Plus
  SIGNAL BinOpOut_37 : unsigned(12 DOWNTO 0);
  -- Concatenation
  ...
  -- Concatenation
  SIGNAL BinOpOut_41 : unsigned(13 DOWNTO 0);
  -- Test for equality
  SIGNAL BinOpOut_42 : std_logic;
  -- One-Hot Multiplexer
  SIGNAL ConstOut_17 : unsigned(0 DOWNTO 0);
  -- Test for equality
  ...
  -- Constant value
  CONSTANT ConstOut_18 : unsigned(3 DOWNTO 0) := "0000";
  -- Constant value
  CONSTANT ConstOut_19 : unsigned(7 DOWNTO 0) := "00000001";
  -- Bitwise OR
  SIGNAL BinOpOut_45 : unsigned(7 DOWNTO 0);
  -- Concatenation
  SIGNAL BinOpOut_46 : unsigned(11 DOWNTO 0);
  -- Test for equality
  ...
  -- Constant value
  CONSTANT ConstOut_20 : unsigned(1 DOWNTO 0) := "01";
  -- Plus
  ...
  -- Constant value
  CONSTANT ConstOut_21 : unsigned(1 DOWNTO 0) := "00";
  -- Test for inequality
  SIGNAL BinOpOut_50 : std_logic;
  -- Bit range selection
  SIGNAL BinOpOut_51 : unsigned(0 DOWNTO 0);
  -- Test for equality
  SIGNAL BinOpOut_52 : std_logic;
  -- Conditional false branch
  SIGNAL WireFalse_14 : std_logic;
  -- Conditional true branch
  SIGNAL WireTrue_17 : std_logic;
  -- Concatenation
  SIGNAL BinOpOut_53 : unsigned(13 DOWNTO 0);
  -- Plus
  SIGNAL BinOpOut_54 : unsigned(13 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_22 : unsigned(2 DOWNTO 0) := "000";
  -- Bit range selection
  SIGNAL BinOpOut_55 : unsigned(12 DOWNTO 0);
  -- Concatenation
  ...
  -- Constant value
  CONSTANT ConstOut_23 : unsigned(17 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  ...
  -- Constant value
  CONSTANT ConstOut_24 : unsigned(31 DOWNTO 0) := "11111111111111111111111111111100";
  -- Conditional true branch
  ...
  -- Constant value
  CONSTANT ConstOut_25 : unsigned(31 DOWNTO 0) := (OTHERS => '0');
  -- Bitwise AND
  ...
  -- Bit range selection
  SIGNAL BinOpOut_70 : unsigned(5 DOWNTO 0);
  -- Conditional true branch
  ...
  -- Constant value
  CONSTANT ConstOut_26 : unsigned(13 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_77 : unsigned(31 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_27 : unsigned(14 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_78 : unsigned(31 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_28 : unsigned(30 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  ...
  -- One-Hot Multiplexer
  SIGNAL S_32 : unsigned(15 DOWNTO 0);
  -- Bit range selection
  ...
  -- Concatenation
  SIGNAL S_89 : unsigned(13 DOWNTO 0);
  -- Test for equality
  ...
  -- Bitwise AND
  SIGNAL S_128 : unsigned(0 DOWNTO 0);
  -- Bitwise AND
  SIGNAL S_129 : unsigned(0 DOWNTO 0);
  -- Bitwise OR
  ...
  -- Range cast
  SIGNAL RangeCast_4 : unsigned(2 DOWNTO 0);
  -- Range cast
  SIGNAL RangeCast_5 : unsigned(2 DOWNTO 0);
  -- Range cast
  SIGNAL RangeCast_6 : unsigned(2 DOWNTO 0);
  -- Concatenation
  SIGNAL MuxEnables_41 : std_logic_vector(5 DOWNTO 0);
  -- Concatenation
  SIGNAL MuxEnables_42 : std_logic_vector(5 DOWNTO 0);
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I8_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I8_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I9_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I9_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I10_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I10_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I11_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I11_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I12_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I12_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I13_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I13_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I14_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I14_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I15_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I15_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 : std_logic;
  -- Component Connector
...
BEGIN
  ...
  PROCESS( BinOpOut_64, MuxEnables ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables IS
      WHEN "10" => ifc_interrupt <= BinOpOut_64;
      WHEN "01" => ifc_interrupt <= ConstOut_21;
  ...
  PROCESS( BinOpOut_56, MuxEnables_4 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_4 IS
      WHEN "10" => ifc_buf_rellen <= BinOpOut_56;
  ...
  PROCESS( swStrPtr, swEndPtr, localSwEndPtr, controlRegister, statusRegister, bufSizeMask, intrRegister, 
    timeoutRegister, BinOpOut_74, BinOpOut_75, BinOpOut_76, BinOpOut_77, BinOpOut_78, BinOpOut_79, MuxEnables_6 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_6 IS
      ...
      WHEN "000000010000000" => ifc_sw_drd <= BinOpOut_74;
      WHEN "000000001000000" => ifc_sw_drd <= BinOpOut_75;
      WHEN "000000000100000" => ifc_sw_drd <= BinOpOut_76;
      WHEN "000000000010000" => ifc_sw_drd <= BinOpOut_77;
      WHEN "000000000001000" => ifc_sw_drd <= BinOpOut_78;
      WHEN "000000000000100" => ifc_sw_drd <= localSwEndPtr;
      WHEN "000000000000010" => ifc_sw_drd <= BinOpOut_79;
      WHEN "000000000000001" => ifc_sw_drd <= ConstOut_25;
      WHEN OTHERS => ifc_sw_drd <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_68, MuxEnables_7 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_7 IS
      WHEN "10" => ifc_sw_ardy <= BinOpOut_68;
  ...
  PROCESS( S_0, MuxEnables_9 ) BEGIN
    ...
    CASE MuxEnables_9 IS
      ...
      WHEN "01" => ifc_dma_dout <= ifc_buf_rellen_1;
  ...
  PROCESS( S_93, S_95, MuxEnables_11 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_11 IS
      WHEN "10" => S_92 <= to_unsigned(S_93);
      WHEN "01" => S_92 <= S_95;
      WHEN OTHERS => S_92 <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( SW_DWR, BinOpOut_62, MuxEnables_12 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_12 IS
      WHEN "10" => swEndPtr_MuxOut <= BinOpOut_62;
      WHEN "01" => swEndPtr_MuxOut <= UNSIGNED(SW_DWR);
      WHEN OTHERS => swEndPtr_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( SW_DWR, BinOpOut_39, MuxEnables_13 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_13 IS
      WHEN "10" => localSwEndPtr_MuxOut <= BinOpOut_39;
  ...
  PROCESS( BinOpOut_58, BinOpOut_59, MuxEnables_15 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_15 IS
      WHEN "10" => intrMonitor_MuxOut <= BinOpOut_58;
      WHEN "01" => intrMonitor_MuxOut <= BinOpOut_59;
  ...
  PROCESS( BinOpOut_71, MuxEnables_17 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_17 IS
      WHEN "10" => interruptEnable_MuxOut <= dataDMAProgressCnt_Down_1;
      WHEN "01" => interruptEnable_MuxOut <= BinOpOut_71;
      WHEN OTHERS => interruptEnable_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_72, MuxEnables_18 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_18 IS
      WHEN "10" => timeoutEnable_MuxOut <= dataDMAProgressCnt_Down_1;
      WHEN "01" => timeoutEnable_MuxOut <= BinOpOut_72;
      WHEN OTHERS => timeoutEnable_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_67, MuxEnables_19 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_19 IS
      WHEN "10" => timeoutMonitor_MuxOut <= ConstOut_25;
      WHEN "01" => timeoutMonitor_MuxOut <= BinOpOut_67;
  ...
  PROCESS( BinOpOut_48, BinOpOut_49, MuxEnables_23 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_23 IS
      WHEN "10" => dma_done_cnt_MuxOut <= BinOpOut_48;
      WHEN "01" => dma_done_cnt_MuxOut <= BinOpOut_49;
  ...
  PROCESS( BinOpOut_70, WireTrue_26 ) BEGIN
    -- Switch Decoder
    CASE BinOpOut_70 IS
  ...
  PROCESS( WireTrue_24, BinOpOut_70 ) BEGIN
    -- Switch Decoder
    CASE BinOpOut_70 IS
  ...
  PROCESS( BinOpOut_53, BinOpOut_54, MuxEnables_31 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_31 IS
      WHEN "100" => length_MuxOut <= ConstOut_26;
      WHEN "010" => length_MuxOut <= BinOpOut_53;
      WHEN "001" => length_MuxOut <= BinOpOut_54;
      WHEN OTHERS => length_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_36, MuxEnables_32 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_32 IS
      WHEN "10" => descOffset_MuxOut <= ConstOut_11;
      WHEN "01" => descOffset_MuxOut <= BinOpOut_36;
  ...
  PROCESS( MuxEnables_35 ) BEGIN
    ...
    CASE MuxEnables_35 IS
      WHEN "10" => ConstOut_17 <= ConstOut;
      WHEN "01" => ConstOut_17 <= dataDMAProgressCnt_Down_1;
      WHEN OTHERS => ConstOut_17 <= (OTHERS => 'X');
    END CASE;
  END PROCESS;
  ...
  PROCESS( PIN_CLK ) BEGIN
    IF rising_edge( PIN_CLK ) THEN
      ...
      ELSE
        ...
        Z_Dones_2 <= CForkIn_1;
        LoopZ_7 <= S_10;
        S_137 <= to_stdlogic(S_138);
        S_135 <= to_stdlogic(S_136);
        S_134 <= S_135;
        ...
        IF ( SeqChain_4='1' ) THEN
          hwStrPtr <= BinOpOut_37;
        END IF;
  ...
  PROCESS( DESC_DO, BinOpOut_30, BinOpOut_32, BinOpOut_33, BinOpOut_34, BinOpOut_35, MuxEnables_41 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_41 IS
      WHEN "100000" => S_32 <= UNSIGNED(DESC_DO);
      WHEN "010000" => S_32 <= BinOpOut_30;
      WHEN "001000" => S_32 <= BinOpOut_32;
      WHEN "000100" => S_32 <= BinOpOut_33;
      WHEN "000010" => S_32 <= BinOpOut_34;
      WHEN "000001" => S_32 <= BinOpOut_35;
  ...
  PROCESS( BinOpOut_13, MuxEnables_42 ) BEGIN
    ...
    CASE MuxEnables_42 IS
      WHEN "100000" => BinOpOut_80 <= BinOpOut_13;
      WHEN "010000" => BinOpOut_80 <= ConstOut_9;
      WHEN "001000" => BinOpOut_80 <= ConstOut_10;
      WHEN "000100" => BinOpOut_80 <= ConstOut_14;
      WHEN "000010" => BinOpOut_80 <= ConstOut_15;
      WHEN "000001" => BinOpOut_80 <= ConstOut_22;
      WHEN OTHERS => BinOpOut_80 <= (OTHERS => 'X');
    END CASE;
  END PROCESS;
  ...
  MuxEnables_3 <= CForkIn_1 & S_125;
  MuxEnables_4 <= S_5 & S_84;
  ...
  MuxEnables_6 <= LinkWire_0_1 & LinkWire_1 & LinkWire_2_1 & LinkWire_3_1 & LinkWire_4_1 & LinkWire_5_1 & 
    ...
    LinkWire_13));
  MuxEnables_7 <= CForkIn_13 & S_126;
  MuxEnables_8 <= CForkIn_13 & S_126;
  S_126 <= not(CForkIn_13);
  MuxEnables_9 <= CForkIn_1 & S_125;
  S_125 <= not(CForkIn_1);
  MuxEnables_10 <= WireTrue_14 & not(WireTrue_14);
  DataIntoFIFO_0 <= BinOpOut_41(0 DOWNTO 0);
  DataIntoFIFO_1 <= BinOpOut_41(1 DOWNTO 1);
  DataIntoFIFO_2 <= BinOpOut_41(2 DOWNTO 2);
  DataIntoFIFO_3 <= BinOpOut_41(3 DOWNTO 3);
  DataIntoFIFO_4 <= BinOpOut_41(4 DOWNTO 4);
  DataIntoFIFO_5 <= BinOpOut_41(5 DOWNTO 5);
  DataIntoFIFO_6 <= BinOpOut_41(6 DOWNTO 6);
  DataIntoFIFO_7 <= BinOpOut_41(7 DOWNTO 7);
  DataIntoFIFO_8 <= BinOpOut_41(8 DOWNTO 8);
  DataIntoFIFO_9 <= BinOpOut_41(9 DOWNTO 9);
  DataIntoFIFO_10 <= BinOpOut_41(10 DOWNTO 10);
  DataIntoFIFO_11 <= BinOpOut_41(11 DOWNTO 11);
  DataIntoFIFO_12 <= BinOpOut_41(12 DOWNTO 12);
  DataIntoFIFO_13 <= BinOpOut_41(13 DOWNTO 13);
  S_89 <= to_unsigned(S_110) & to_unsigned(S_109) & to_unsigned(S_108) & to_unsigned(S_107) & to_unsigned(S_106) & 
  ...
  S_96 <= not((to_unsigned(S_90) and not(to_unsigned(S_93))));
  S_95 <= S_94 and S_7;
  S_94 <= not((to_unsigned(S_90) and to_unsigned(S_93)));
  MuxEnables_11 <= to_stdlogic(not(S_91)) & to_stdlogic(S_91);
  S_91 <= S_95 xor AckOut;
  S_90 <= to_stdlogic(S_85 = S_87);
  S_88 <= S_87 + ConstOut;
  S_86 <= S_85 + ConstOut;
  AckOut <= S_3 and S_96;
  swEndPtr_CE <= WireTrue_19 or WireTrue_25;
  MuxEnables_12 <= WireTrue_19 & WireTrue_25;
  localSwEndPtr_CE <= SeqChain_4 or WireTrue_25;
  MuxEnables_13 <= SeqChain_4 & WireTrue_25;
  ...
  MuxEnables_21 <= SeqChain_4 & not(SeqChain_4);
  MuxEnables_22 <= S_5 & S_84;
  S_84 <= not(S_5);
  ...
  BinOpOut_79 <= ConstOut_28 & debugDmaAckWait;
  BinOpOut_78 <= ConstOut_27 & dataDMAProgressCnt_Down & ifc_buf_rellen;
  BinOpOut_77 <= ConstOut_26 & to_unsigned(VCC) & to_unsigned(BUF_NEWLEN_DV) & UNSIGNED(BUF_NEWLEN);
  BinOpOut_76 <= ConstOut_26 & ifc_desc_read & to_unsigned(DESC_EMPTY) & UNSIGNED(DESC_DO);
  BinOpOut_75 <= ConstOut_13 & hwEndPtr;
  BinOpOut_74 <= ConstOut_13 & hwStrPtr;
  ...
  WireTrue_26 <= WireFalse_19 and BinOpOut_73;
  BinOpOut_73 <= to_stdlogic(to_unsigned(SW_RD) = ConstOut);
  RangeCast <= UNSIGNED(SW_DWR);
  BinOpOut_72 <= RangeCast(0 DOWNTO 0);
  RangeCast_1 <= UNSIGNED(SW_DWR);
  BinOpOut_71 <= RangeCast_1(1 DOWNTO 1);
  ...
  BinOpOut_70 <= RangeCast_2(5 DOWNTO 0);
  S_133 <= LinkWire_13 or LinkWire_12 or LinkWire_11 or LinkWire_10 or LinkWire_9 or LinkWire_8 or LinkWire_7 or 
    LinkWire_6_1 or LinkWire_5_1 or LinkWire_4_1 or LinkWire_3_1 or LinkWire_2_1 or LinkWire_1 or LinkWire_0_1 or 
    SwitchOut(0) or (WireFalse_19 and not(BinOpOut_73)) or LinkWire_6 or LinkWire_5 or LinkWire_4 or 
    LinkWire_2 or SwitchOut_1(6) or LinkWire_0 or SwitchOut_1(0) or WireTrue_25 or (LinkWire_3 and not(
    BinOpOut_16));
  WireTrue_24 <= CForkIn_13 and BinOpOut_69;
  WireFalse_19 <= CForkIn_13 and not(BinOpOut_69);
  BinOpOut_69 <= to_stdlogic(to_unsigned(SW_WR) = ConstOut);
  BinOpOut_68 <= to_unsigned(SW_WR) or to_unsigned(SW_RD);
  CForkIn_13 <= StartOut_10 or to_stdlogic(LoopZ_6);
  BinOpOut_67 <= timeoutMonitor + ConstOut_1;
  WireTrue_23 <= WireFalse_17 and to_stdlogic(BinOpOut_66);
  WireFalse_18 <= WireFalse_17 and not(to_stdlogic(BinOpOut_66));
  BinOpOut_66 <= to_unsigned(to_stdlogic(timeoutEnable = ConstOut)) and to_unsigned(to_stdlogic(timeoutExpired = 
    ConstOut));
  S_19 <= WireTrue_23 or WireFalse_18 or WireTrue_22;
  WireTrue_22 <= CForkIn_12 and to_stdlogic(BinOpOut_65);
  WireFalse_17 <= CForkIn_12 and not(to_stdlogic(BinOpOut_65));
  BinOpOut_65 <= to_unsigned(BinOpOut_5) or to_unsigned(BinOpOut_57);
  S_127 <= to_unsigned(to_stdlogic(intrReset = dataDMAProgressCnt_Down_1)) and to_unsigned(to_stdlogic(
    regIntrMonitor >= (intrRegister and ConstOut_24))) and to_unsigned(to_stdlogic(interruptEnable = 
    ConstOut));
  WireTrue_21 <= CForkIn_12 and to_stdlogic(S_127);
  CForkIn_12 <= StartOut_9 or Z_Dones_1_5;
  BinOpOut_64 <= ifc_interrupt1 & ifc_interrupt0;
  CForkIn_11 <= StartOut_8 or Z_Dones_1_3;
  S_18 <= WireTrue_20 or WireFalse_16;
  WireTrue_20 <= CForkIn_10 and BinOpOut_63;
  WireFalse_16 <= CForkIn_10 and not(BinOpOut_63);
  BinOpOut_63 <= to_stdlogic(timeoutMonitor >= timeoutRegister);
  CForkIn_10 <= StartOut_7 or LoopZ_8;
  length_CE <= S_24 or WireTrue_17 or WireFalse_14;
  MuxEnables_31 <= S_24 & WireTrue_17 & WireFalse_14;
  BinOpOut_62 <= (swEndPtr + BinOpOut_61) and bufSizeMask;
  BinOpOut_61 <= ConstOut_23 & length_1;
  WireTrue_19 <= Z_Dones_5 and BinOpOut_60;
  BinOpOut_60 <= to_stdlogic(BinOpOut_51 = dataDMAProgressCnt_Down_1);
  S_17 <= WireTrue_18 or WireFalse_15;
  BinOpOut_59 <= intrMonitor + BinOpOut_58;
  BinOpOut_58 <= ConstOut_13 & BinOpOut_55;
  WireTrue_18 <= S_5 and BinOpOut_57;
  WireFalse_15 <= S_5 and not(BinOpOut_57);
  BinOpOut_57 <= to_stdlogic(intrReset = ConstOut);
  BinOpOut_54 <= length_1 + BinOpOut_53;
  BinOpOut_53 <= dataDMAProgressCnt_Down_1 & BinOpOut_55;
  WireTrue_17 <= S_5 and BinOpOut_52;
  WireFalse_14 <= S_5 and not(BinOpOut_52);
  BinOpOut_52 <= to_stdlogic(BinOpOut_51 = ConstOut);
  BinOpOut_51 <= flag_length(13 DOWNTO 13);
  BinOpOut_56 <= ConstOut_22 & BinOpOut_55;
  BinOpOut_55 <= flag_length(12 DOWNTO 0);
  S_2 <= to_stdlogic(S_3) and to_stdlogic(S_96);
  False_fork_input <= to_stdlogic(S_3) and not(to_stdlogic(S_96));
  S_3 <= to_unsigned(CForkIn_16 and BinOpOut_50) or to_unsigned(S_4);
  BinOpOut_50 <= to_stdlogic(dma_done_cnt /= ConstOut_21);
  S_15 <= WireTrue_19 or (Z_Dones_5 and not(BinOpOut_60)) or (CForkIn_16 and not(BinOpOut_50)) or StartOut_6;
  S_24 <= StartOut_6 or WireTrue_19;
  BinOpOut_49 <= dma_done_cnt - ConstOut_20;
  WireTrue_16 <= WireFalse_13 and BinOpOut_1;
  S_128 <= to_unsigned(BinOpOut_1) and to_unsigned(BinOpOut_44) and to_unsigned(BinOpOut_47);
  WireFalse_13 <= WireFalse_12 and not(to_stdlogic(S_128));
  BinOpOut_47 <= to_stdlogic(RESIZE(UNSIGNED(DMA_TAG), 12) = BinOpOut_46);
  BinOpOut_46 <= ConstOut_18 & BinOpOut_45;
  BinOpOut_45 <= ConstOut_19 or UNSIGNED(DMA_TAG_ID);
  S_129 <= to_unsigned(BinOpOut_47) and to_unsigned(to_stdlogic(dataDMAProgressCnt_Down = dataDMAProgressCnt_Down_1)) and 
    to_unsigned(BinOpOut_44);
  S_16 <= WireTrue_16 or (WireFalse_13 and not(BinOpOut_1)) or (WireFalse_12 and to_stdlogic(S_128)) or 
    WireTrue_15;
  BinOpOut_48 <= dma_done_cnt + ConstOut_20;
  WireTrue_15 <= CForkIn_9 and to_stdlogic(S_129);
  WireFalse_12 <= CForkIn_9 and not(to_stdlogic(S_129));
  BinOpOut_44 <= to_stdlogic(to_unsigned(DMA_DONE) = ConstOut);
  CForkIn_9 <= StartOut_5 or Z_Dones_0;
  descOffset_CE <= WireTrue_8 or SeqChain_4;
  MuxEnables_32 <= WireTrue_8 & SeqChain_4;
  ...
  MuxEnables_35 <= BinOpOut_42 & not(BinOpOut_42);
  S_6 <= to_stdlogic(S_7) and to_stdlogic(S_94);
  False_fork_input_1 <= to_stdlogic(S_7) and not(to_stdlogic(S_94));
  S_7 <= to_unsigned(WireFalse_11) or to_unsigned(S_8);
  BinOpOut_41 <= pageBreakFlag & length;
  BinOpOut_42 <= to_stdlogic(descOffset = ConstOut_11);
  S_14 <= SeqChain_4 or WireTrue_14;
  WireTrue_14 <= CForkIn_15 and BinOpOut_40;
  WireFalse_11 <= CForkIn_15 and not(BinOpOut_40);
  BinOpOut_40 <= to_stdlogic(to_unsigned(DMA_ACK) = dataDMAProgressCnt_Down_1);
  BinOpOut_39 <= (localSwEndPtr + BinOpOut_38) and bufSizeMask;
  BinOpOut_38 <= ConstOut_13 & length;
  BinOpOut_37 <= hwStrPtr + length;
  BinOpOut_36 <= descOffset + RESIZE(length, 12);
  BinOpOut_31 <= UNSIGNED(BUFFER_ADDR) + BinOpOut_74;
  BinOpOut_30 <= S_1(15 DOWNTO 12) & descOffset;
  ...
  WireTrue_12 <= SeqChain_5 and BinOpOut_27;
  WireFalse_8 <= SeqChain_5 and not(BinOpOut_27);
  ...
  BinOpOut_35 <= length(11 DOWNTO 0) & ConstOut_16;
  BinOpOut_34 <= ConstOut_3 & BinOpOut_45;
  BinOpOut_33 <= laddr(15 DOWNTO 0);
  BinOpOut_32 <= laddr(31 DOWNTO 16);
  ...
  BinOpOut_19 <= to_unsigned(BinOpOut_43) and to_unsigned(BinOpOut_17);
  CForkIn_8 <= (CForkIn_17 and to_stdlogic(S_130)) or Z_Dones_1_1;
  S_132 <= S_9 or WireTrue_12 or WireFalse_6 or (CForkIn_7 and not(to_stdlogic(BinOpOut_18)));
  S_130 <= to_unsigned(to_stdlogic(pageBreakFlag = ConstOut)) or to_unsigned(BinOpOut_43) or to_unsigned(to_stdlogic(
    controlRegister(0 DOWNTO 0) = ConstOut));
  BinOpOut_43 <= to_stdlogic(controlRegister(1 DOWNTO 1) = ConstOut);
  ...
  CForkIn_7 <= (CForkIn_17 and not(to_stdlogic(S_130))) or Z_Dones_4 or StartOut_4;
  ...
  BinOpOut_4 <= dataDMAProgressCnt - ConstOut_19;
  WireTrue_1 <= WireFalse_1 and BinOpOut_1;
  BinOpOut_3 <= dataDMAProgressCnt + ConstOut_19;
  ...
  S_138 <= to_unsigned(S_134) or to_unsigned(Z_Dones_1_2) or to_unsigned(WireFalse_10);
  S_136 <= to_unsigned(Z_Dones_1_2) or to_unsigned(WireFalse_10);
  S_131 <= to_unsigned(S_137) or to_unsigned(WireFalse_10) or to_unsigned(WireTrue_7);
  S_1 <= to_unsigned(S_83) & to_unsigned(S_82) & to_unsigned(S_81) & to_unsigned(S_80) & to_unsigned(S_79) & 
    ...
    to_unsigned(S_68);
  S_36 <= S_32(0 DOWNTO 0);
  S_37 <= S_32(1 DOWNTO 1);
  S_38 <= S_32(2 DOWNTO 2);
  S_39 <= S_32(3 DOWNTO 3);
  S_40 <= S_32(4 DOWNTO 4);
  S_41 <= S_32(5 DOWNTO 5);
  S_42 <= S_32(6 DOWNTO 6);
  S_43 <= S_32(7 DOWNTO 7);
  S_44 <= S_32(8 DOWNTO 8);
  S_45 <= S_32(9 DOWNTO 9);
  S_46 <= S_32(10 DOWNTO 10);
  S_47 <= S_32(11 DOWNTO 11);
  S_48 <= S_32(12 DOWNTO 12);
  S_49 <= S_32(13 DOWNTO 13);
  S_50 <= S_32(14 DOWNTO 14);
  S_51 <= S_32(15 DOWNTO 15);
  BinOpOut_0 <= BinOpOut_80(0 DOWNTO 0);
  BinOpOut_1_1 <= BinOpOut_80(1 DOWNTO 1);
  BinOpOut_2_1 <= BinOpOut_80(2 DOWNTO 2);
  S_0 <= to_unsigned(S_67) & to_unsigned(S_66) & to_unsigned(S_65) & to_unsigned(S_64) & to_unsigned(S_63) & 
    to_unsigned(S_62) & to_unsigned(S_61) & to_unsigned(S_60) & to_unsigned(S_59) & to_unsigned(S_58) & 
    to_unsigned(S_57) & to_unsigned(S_56) & to_unsigned(S_55) & to_unsigned(S_54) & to_unsigned(S_53) & 
    to_unsigned(S_52);
  ...
  MuxEnables_41 <= WireTrue_7 & WireFalse_10 & Z_Dones_1_2 & SeqChain_1 & SeqChain_2 & SeqChain_3;
  MuxEnables_42 <= WireTrue_7 & SeqChain_2 & WireFalse_10 & Z_Dones_1_2 & SeqChain_1 & SeqChain_3;
  ...
  I0_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I0_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I0_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I1_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I1_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I1_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I2_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I2_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I2_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I3_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I3_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I3_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I4_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I4_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I4_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I5_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I5_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I5_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I6_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I6_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I6_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I7_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I7_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I7_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I8_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I8_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I8_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I9_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I9_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I9_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I10_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I10_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I10_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I11_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I11_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I11_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I12_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I12_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I12_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  I13_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_85);
  ...
  I13_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_87);
  ...
  I13_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_95);
  ...
  I0_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_51);
  ...
  I0_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I1_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_50);
  ...
  I1_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I2_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_49);
  ...
  I2_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I3_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_48);
  ...
  I3_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I4_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_47);
  ...
  I4_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I5_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_46);
  ...
  I5_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I6_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_45);
  ...
  I6_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I7_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_44);
  ...
  I7_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I8_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I8_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I8_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_43);
  I8_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I8_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I8_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I8_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I8_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I9_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I9_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I9_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_42);
  I9_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I9_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I9_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I9_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I9_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I10_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I10_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I10_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_41);
  I10_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I10_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I10_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I10_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I10_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I11_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I11_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I11_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_40);
  I11_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I11_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I11_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I11_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I11_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I12_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I12_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I12_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_39);
  I12_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I12_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I12_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I12_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I12_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I13_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I13_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I13_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_38);
  I13_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I13_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I13_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I13_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I13_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I14_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I14_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I14_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_37);
  I14_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I14_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I14_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I14_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I14_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I15_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2 <= to_stdlogic(BinOpOut_2_1);
  I15_DMAReqMem_rx_dma_ctrl_opt_208_A3_GND <= GND;
  I15_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_36);
  I15_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_33);
  I15_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_34);
  I15_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_35);
  I15_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3_GND <= GND;
  I15_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_131);
  ...
  I8_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I8_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I8_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I9_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I9_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I9_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I10_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I10_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I10_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I11_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I11_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I11_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I12_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I12_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I12_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I13_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I13_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I13_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I14_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I14_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I14_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
  ...
  I15_DMAReqMem_rx_dma_ctrl_opt_208 : RAM16X1D
    ...
    PORT MAP (
      ...
      A2 => I15_DMAReqMem_rx_dma_ctrl_opt_208_A2_BinOpOut_2,
      ...
      DPRA2 => I15_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2,
