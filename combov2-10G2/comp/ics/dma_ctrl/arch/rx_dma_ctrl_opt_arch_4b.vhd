--------------------------------------------------------------------
-- Name: rx_dma_ctrl_opt_arch_4b.vhd
...
ENTITY rx_dma_ctrl_opt_arch_4b IS
...
-- this is the top level entity
ARCHITECTURE behaviour OF rx_dma_ctrl_opt_arch_4b IS
component RAM16X1D
        generic (
...
component RAM64X1D
  ...
  -- Constant value
  CONSTANT ConstOut_9 : unsigned(4 DOWNTO 0) := "00000";
  -- Clock cycle delay
  ...
  -- Constant value
  CONSTANT ConstOut_10 : unsigned(4 DOWNTO 0) := "00001";
  -- Plus
  SIGNAL BinOpOut_14 : unsigned(4 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_11 : unsigned(4 DOWNTO 0) := "10000";
  ...
  -- Bit range selection
  SIGNAL BinOpOut_16 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_13 : unsigned(4 DOWNTO 0) := "00100";
  -- Clock cycle delay
  SIGNAL SeqChain_3 : std_logic;
  -- Bit range selection
  SIGNAL BinOpOut_17 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_14 : unsigned(4 DOWNTO 0) := "00101";
  -- Clock cycle delay
  SIGNAL SeqChain_4 : std_logic;
  -- Bit range selection
  SIGNAL BinOpOut_18 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_15 : unsigned(4 DOWNTO 0) := "00110";
  -- Bit range selection
  SIGNAL BinOpOut_19 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_16 : unsigned(4 DOWNTO 0) := "00111";
  -- Concatenation
  SIGNAL BinOpOut_20 : unsigned(15 DOWNTO 0);
  -- Control path join
  SIGNAL CForkIn_7 : std_logic;
  -- Conditional true branch
  SIGNAL WireTrue_8 : std_logic;
  -- Constant value
  CONSTANT ConstOut_17 : unsigned(11 DOWNTO 0) := (OTHERS => '0');
  -- Clock cycle delay
  ...
  -- Minus
  SIGNAL BinOpOut_28 : unsigned(12 DOWNTO 0);
  -- Bitwise AND
  SIGNAL BinOpOut_29 : unsigned(31 DOWNTO 0);
  -- Clock cycle delay
  SIGNAL Z_Dones_4_1 : std_logic;
  -- Constant value
  CONSTANT ConstOut_18 : unsigned(12 DOWNTO 0) := "1000000000000";
  ...
  -- Constant value
  CONSTANT ConstOut_19 : unsigned(18 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_31 : unsigned(31 DOWNTO 0);
  -- Test for unsigned greater than
  SIGNAL BinOpOut_32 : std_logic;
  -- Conditional false branch
  ...
  -- Bit range selection
  SIGNAL BinOpOut_35 : unsigned(3 DOWNTO 0);
  -- Clock cycle delay
  SIGNAL SeqChain_7 : std_logic;
  -- Bit range selection
  SIGNAL BinOpOut_36 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_20 : unsigned(4 DOWNTO 0) := "10001";
  -- Bit range selection
  SIGNAL BinOpOut_37 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_21 : unsigned(4 DOWNTO 0) := "10010";
  -- Clock cycle delay
  ...
  -- Bit range selection
  SIGNAL BinOpOut_48 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_30 : unsigned(4 DOWNTO 0) := "00010";
  -- Bit range selection
  SIGNAL BinOpOut_49 : unsigned(3 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_31 : unsigned(4 DOWNTO 0) := "00011";
  -- Plus
  SIGNAL BinOpOut_50 : unsigned(11 DOWNTO 0);
  -- Plus
  SIGNAL BinOpOut_51 : unsigned(12 DOWNTO 0);
  -- Concatenation
  SIGNAL BinOpOut_52 : unsigned(31 DOWNTO 0);
  -- Bitwise AND
  ...
  -- Concatenation
  SIGNAL BinOpOut_55 : unsigned(13 DOWNTO 0);
  -- Test for equality
  SIGNAL BinOpOut_56 : std_logic;
  -- One-Hot Multiplexer
  SIGNAL ConstOut_32 : unsigned(0 DOWNTO 0);
  -- Test for equality
  ...
  -- Constant value
  CONSTANT ConstOut_33 : unsigned(3 DOWNTO 0) := "0000";
  -- Constant value
  CONSTANT ConstOut_34 : unsigned(7 DOWNTO 0) := "00000001";
  -- Bitwise OR
  SIGNAL BinOpOut_59 : unsigned(7 DOWNTO 0);
  -- Concatenation
  SIGNAL BinOpOut_60 : unsigned(11 DOWNTO 0);
  -- Test for equality
  SIGNAL BinOpOut_61 : std_logic;
  -- Conditional false branch
  SIGNAL WireFalse_12 : std_logic;
  -- Conditional true branch
  SIGNAL WireTrue_15 : std_logic;
  -- Constant value
  CONSTANT ConstOut_35 : unsigned(1 DOWNTO 0) := "01";
  -- Plus
  ...
  -- Constant value
  CONSTANT ConstOut_36 : unsigned(1 DOWNTO 0) := "00";
  -- Test for inequality
  ...
  -- Concatenation
  SIGNAL BinOpOut_67 : unsigned(13 DOWNTO 0);
  -- Plus
  SIGNAL BinOpOut_68 : unsigned(13 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_37 : unsigned(2 DOWNTO 0) := "000";
  -- Bit range selection
  SIGNAL BinOpOut_69 : unsigned(12 DOWNTO 0);
  -- Concatenation
  SIGNAL BinOpOut_70 : unsigned(15 DOWNTO 0);
  -- Test for equality
  ...
  -- Test for equality
  SIGNAL BinOpOut_74 : std_logic;
  -- Conditional true branch
  SIGNAL WireTrue_19 : std_logic;
  -- Constant value
  CONSTANT ConstOut_38 : unsigned(17 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  ...
  -- Concatenation
  SIGNAL BinOpOut_78 : unsigned(1 DOWNTO 0);
  -- Clock cycle delay
  SIGNAL Z_Dones_1_2 : std_logic;
  -- Control path join
  SIGNAL CForkIn_12 : std_logic;
  -- Constant value
  CONSTANT ConstOut_39 : unsigned(31 DOWNTO 0) := "11111111111111111111111111111100";
  -- Conditional true branch
  ...
  -- Constant value
  CONSTANT ConstOut_40 : unsigned(31 DOWNTO 0) := (OTHERS => '0');
  -- Bitwise AND
  ...
  -- Bit range selection
  SIGNAL BinOpOut_84 : unsigned(5 DOWNTO 0);
  -- Conditional true branch
  ...
  -- Constant value
  CONSTANT ConstOut_41 : unsigned(25 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_90 : unsigned(31 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_42 : unsigned(13 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_91 : unsigned(31 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_43 : unsigned(14 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_92 : unsigned(31 DOWNTO 0);
  -- Constant value
  CONSTANT ConstOut_44 : unsigned(30 DOWNTO 0) := (OTHERS => '0');
  -- Concatenation
  SIGNAL BinOpOut_93 : unsigned(31 DOWNTO 0);
  -- Bit selection
  ...
  -- One-Hot Multiplexer
  SIGNAL BinOpOut_94 : unsigned(4 DOWNTO 0);
  -- One-Hot Multiplexer
  SIGNAL S_31 : unsigned(3 DOWNTO 0);
  -- Bit range selection
  ...
  -- Concatenation
  SIGNAL S_54 : unsigned(13 DOWNTO 0);
  -- Test for equality
  ...
  -- Range cast
  SIGNAL RangeCast_4 : unsigned(4 DOWNTO 0);
  -- Range cast
  ...
  -- Concatenation
  SIGNAL MuxEnables_41 : std_logic_vector(19 DOWNTO 0);
  -- Concatenation
  SIGNAL MuxEnables_42 : std_logic_vector(19 DOWNTO 0);
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I2_DMAReqMem_rx_dma_ctrl_opt_208_A4_BinOpOut_4 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA4 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I3_DMAReqMem_rx_dma_ctrl_opt_208_A4_BinOpOut_4 : std_logic;
  -- Component Connector
  ...
  -- Component Connector
  SIGNAL I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA4 : std_logic;
  -- Component Connector
...
BEGIN
  ...
  PROCESS( BinOpOut_78, MuxEnables ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables IS
      WHEN "10" => ifc_interrupt <= BinOpOut_78;
      WHEN "01" => ifc_interrupt <= ConstOut_36;
  ...
  PROCESS( BinOpOut_70, MuxEnables_4 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_4 IS
      WHEN "10" => ifc_buf_rellen <= BinOpOut_70;
  ...
  PROCESS( swStrPtr, swEndPtr, localSwEndPtr, controlRegister, statusRegister, bufSizeMask, intrRegister, 
    timeoutRegister, BinOpOut_88, BinOpOut_89, BinOpOut_90, BinOpOut_91, BinOpOut_92, BinOpOut_93, MuxEnables_6 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_6 IS
      ...
      WHEN "000000010000000" => ifc_sw_drd <= BinOpOut_88;
      WHEN "000000001000000" => ifc_sw_drd <= BinOpOut_89;
      WHEN "000000000100000" => ifc_sw_drd <= BinOpOut_90;
      WHEN "000000000010000" => ifc_sw_drd <= BinOpOut_91;
      WHEN "000000000001000" => ifc_sw_drd <= BinOpOut_92;
      WHEN "000000000000100" => ifc_sw_drd <= localSwEndPtr;
      WHEN "000000000000010" => ifc_sw_drd <= BinOpOut_93;
      WHEN "000000000000001" => ifc_sw_drd <= ConstOut_40;
      WHEN OTHERS => ifc_sw_drd <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_82, MuxEnables_7 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_7 IS
      WHEN "10" => ifc_sw_ardy <= BinOpOut_82;
  ...
  PROCESS( S_0, MuxEnables_9 ) BEGIN
    ...
    CASE MuxEnables_9 IS
      ...
      WHEN "01" => ifc_dma_dout <= ConstOut_33;
  ...
  PROCESS( PIN_CLK ) BEGIN
    IF rising_edge( PIN_CLK ) THEN
      ...
      ELSE
        ...
        Z_Dones_0 <= S_15;
        SeqChain_8 <= SeqChain_5;
        S_8 <= S_5;
        S_7 <= False_fork_input_1;
        CForkIn_15 <= S_13;
        SeqChain_17 <= SeqChain_19;
        SeqChain_19 <= SeqChain_18;
        SeqChain_18 <= SeqChain_9;
        SeqChain_9 <= SeqChain_16;
        ...
        SeqChain_10 <= SeqChain_8;
        SeqChain_5 <= SeqChain_7;
        SeqChain_7 <= SeqChain_6;
        SeqChain_6 <= WireFalse_10;
        CForkIn_14 <= S_12;
  ...
  PROCESS( S_58, S_60, MuxEnables_11 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_11 IS
      WHEN "10" => S_57 <= to_unsigned(S_58);
      WHEN "01" => S_57 <= S_60;
      WHEN OTHERS => S_57 <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( SW_DWR, BinOpOut_76, MuxEnables_12 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_12 IS
      WHEN "10" => swEndPtr_MuxOut <= BinOpOut_76;
      WHEN "01" => swEndPtr_MuxOut <= UNSIGNED(SW_DWR);
      WHEN OTHERS => swEndPtr_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( SW_DWR, BinOpOut_53, MuxEnables_13 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_13 IS
      WHEN "10" => localSwEndPtr_MuxOut <= BinOpOut_53;
  ...
  PROCESS( BinOpOut_72, BinOpOut_73, MuxEnables_15 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_15 IS
      WHEN "10" => intrMonitor_MuxOut <= BinOpOut_72;
      WHEN "01" => intrMonitor_MuxOut <= BinOpOut_73;
  ...
  PROCESS( BinOpOut_85, MuxEnables_17 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_17 IS
      WHEN "10" => interruptEnable_MuxOut <= dataDMAProgressCnt_Down_1;
      WHEN "01" => interruptEnable_MuxOut <= BinOpOut_85;
      WHEN OTHERS => interruptEnable_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_86, MuxEnables_18 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_18 IS
      WHEN "10" => timeoutEnable_MuxOut <= dataDMAProgressCnt_Down_1;
      WHEN "01" => timeoutEnable_MuxOut <= BinOpOut_86;
      WHEN OTHERS => timeoutEnable_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_81, MuxEnables_19 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_19 IS
      WHEN "10" => timeoutMonitor_MuxOut <= ConstOut_40;
      WHEN "01" => timeoutMonitor_MuxOut <= BinOpOut_81;
  ...
  PROCESS( BinOpOut_62, BinOpOut_63, MuxEnables_23 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_23 IS
      WHEN "10" => dma_done_cnt_MuxOut <= BinOpOut_62;
      WHEN "01" => dma_done_cnt_MuxOut <= BinOpOut_63;
  ...
  PROCESS( BinOpOut_84, WireTrue_26 ) BEGIN
    -- Switch Decoder
    CASE BinOpOut_84 IS
  ...
  PROCESS( WireTrue_24, BinOpOut_84 ) BEGIN
    -- Switch Decoder
    CASE BinOpOut_84 IS
  ...
  PROCESS( PIN_CLK ) BEGIN
    IF rising_edge( PIN_CLK ) THEN
      ...
      IF ( WireTrue_10='1' ) THEN
        swFreeSpace <= BinOpOut_29;
      END IF;

      -- Update of register 'laddr'
      IF ( SeqChain_5='1' ) THEN
        laddr <= BinOpOut_38;
      END IF;

      -- Update of register 'pageFreeSpace'
      IF ( WireTrue_10='1' ) THEN
        pageFreeSpace <= BinOpOut_28;
      END IF;

      -- Update of register 'dataLength'
      IF ( WireTrue_10='1' ) THEN
        dataLength <= BinOpOut_26;
      END IF;
  ...
  PROCESS( BinOpOut_67, BinOpOut_68, MuxEnables_31 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_31 IS
      WHEN "100" => length_MuxOut <= ConstOut_42;
      WHEN "010" => length_MuxOut <= BinOpOut_67;
      WHEN "001" => length_MuxOut <= BinOpOut_68;
      WHEN OTHERS => length_MuxOut <= (OTHERS => 'X');
    END CASE;
  END PROCESS;

  PROCESS( BinOpOut_50, MuxEnables_32 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_32 IS
      WHEN "10" => descOffset_MuxOut <= ConstOut_17;
      WHEN "01" => descOffset_MuxOut <= BinOpOut_50;
  ...
  PROCESS( dataLength, MuxEnables_33 ) BEGIN
    ...
    CASE MuxEnables_33 IS
      WHEN "10" => hwDataLength_MuxOut <= ConstOut_18;
  ...
  PROCESS( MuxEnables_35 ) BEGIN
    ...
    CASE MuxEnables_35 IS
      WHEN "10" => ConstOut_32 <= ConstOut;
      WHEN "01" => ConstOut_32 <= dataDMAProgressCnt_Down_1;
      WHEN OTHERS => ConstOut_32 <= (OTHERS => 'X');
    END CASE;
  END PROCESS;
  ...
  PROCESS( PIN_CLK ) BEGIN
    IF rising_edge( PIN_CLK ) THEN
      ...
      ELSE
        ...
        IF ( SeqChain_17='1' ) THEN
          hwStrPtr <= BinOpOut_51;
        END IF;
  ...
  PROCESS( DESC_DO, BinOpOut_16, BinOpOut_17, BinOpOut_18, BinOpOut_19, BinOpOut_35, BinOpOut_36, BinOpOut_37, 
    BinOpOut_39, BinOpOut_40, BinOpOut_41, BinOpOut_42, BinOpOut_43, BinOpOut_44, BinOpOut_45, BinOpOut_46, 
    BinOpOut_47, BinOpOut_48, BinOpOut_49, MuxEnables_41 ) BEGIN
    -- One-Hot Multiplexer
    CASE MuxEnables_41 IS
      WHEN "10000000000000000000" => S_31 <= UNSIGNED(DESC_DO);
      WHEN "01000000000000000000" => S_31 <= ConstOut_12;
      WHEN "00100000000000000000" => S_31 <= BinOpOut_16;
      WHEN "00010000000000000000" => S_31 <= BinOpOut_17;
      WHEN "00001000000000000000" => S_31 <= BinOpOut_18;
      WHEN "00000100000000000000" => S_31 <= BinOpOut_19;
      WHEN "00000010000000000000" => S_31 <= BinOpOut_35;
      WHEN "00000001000000000000" => S_31 <= BinOpOut_36;
      WHEN "00000000100000000000" => S_31 <= BinOpOut_37;
      WHEN "00000000010000000000" => S_31 <= BinOpOut_39;
      WHEN "00000000001000000000" => S_31 <= BinOpOut_40;
      WHEN "00000000000100000000" => S_31 <= BinOpOut_41;
      WHEN "00000000000010000000" => S_31 <= BinOpOut_42;
      WHEN "00000000000001000000" => S_31 <= BinOpOut_43;
      WHEN "00000000000000100000" => S_31 <= BinOpOut_44;
      WHEN "00000000000000010000" => S_31 <= BinOpOut_45;
      WHEN "00000000000000001000" => S_31 <= BinOpOut_46;
      WHEN "00000000000000000100" => S_31 <= BinOpOut_47;
      WHEN "00000000000000000010" => S_31 <= BinOpOut_48;
      WHEN "00000000000000000001" => S_31 <= BinOpOut_49;
  ...
  PROCESS( BinOpOut_13, MuxEnables_42 ) BEGIN
    ...
    CASE MuxEnables_42 IS
      WHEN "10000000000000000000" => BinOpOut_94 <= BinOpOut_13;
      WHEN "01000000000000000000" => BinOpOut_94 <= ConstOut_9;
      WHEN "00100000000000000000" => BinOpOut_94 <= ConstOut_13;
      WHEN "00010000000000000000" => BinOpOut_94 <= ConstOut_14;
      WHEN "00001000000000000000" => BinOpOut_94 <= ConstOut_15;
      WHEN "00000100000000000000" => BinOpOut_94 <= ConstOut_16;
      WHEN "00000010000000000000" => BinOpOut_94 <= ConstOut_11;
      WHEN "00000001000000000000" => BinOpOut_94 <= ConstOut_20;
      WHEN "00000000100000000000" => BinOpOut_94 <= ConstOut_21;
      WHEN "00000000010000000000" => BinOpOut_94 <= ConstOut_22;
      WHEN "00000000001000000000" => BinOpOut_94 <= ConstOut_23;
      WHEN "00000000000100000000" => BinOpOut_94 <= ConstOut_24;
      WHEN "00000000000010000000" => BinOpOut_94 <= ConstOut_25;
      WHEN "00000000000001000000" => BinOpOut_94 <= ConstOut_26;
      WHEN "00000000000000100000" => BinOpOut_94 <= ConstOut_27;
      WHEN "00000000000000010000" => BinOpOut_94 <= ConstOut_28;
      WHEN "00000000000000001000" => BinOpOut_94 <= ConstOut_29;
      WHEN "00000000000000000100" => BinOpOut_94 <= ConstOut_10;
      WHEN "00000000000000000010" => BinOpOut_94 <= ConstOut_30;
      WHEN "00000000000000000001" => BinOpOut_94 <= ConstOut_31;
      WHEN OTHERS => BinOpOut_94 <= (OTHERS => 'X');
    END CASE;
  END PROCESS;
  ...
  MuxEnables_3 <= CForkIn_1 & S_90;
  MuxEnables_4 <= S_4 & S_49;
  ...
  MuxEnables_6 <= LinkWire_0_1 & LinkWire_1 & LinkWire_2_1 & LinkWire_3_1 & LinkWire_4_1 & LinkWire_5_1 & 
    ...
    LinkWire_13));
  MuxEnables_7 <= CForkIn_13 & S_91;
  MuxEnables_8 <= CForkIn_13 & S_91;
  S_91 <= not(CForkIn_13);
  MuxEnables_9 <= CForkIn_1 & S_90;
  S_90 <= not(CForkIn_1);
  MuxEnables_10 <= WireTrue_14 & not(WireTrue_14);
  DataIntoFIFO_0 <= BinOpOut_55(0 DOWNTO 0);
  DataIntoFIFO_1 <= BinOpOut_55(1 DOWNTO 1);
  DataIntoFIFO_2 <= BinOpOut_55(2 DOWNTO 2);
  DataIntoFIFO_3 <= BinOpOut_55(3 DOWNTO 3);
  DataIntoFIFO_4 <= BinOpOut_55(4 DOWNTO 4);
  DataIntoFIFO_5 <= BinOpOut_55(5 DOWNTO 5);
  DataIntoFIFO_6 <= BinOpOut_55(6 DOWNTO 6);
  DataIntoFIFO_7 <= BinOpOut_55(7 DOWNTO 7);
  DataIntoFIFO_8 <= BinOpOut_55(8 DOWNTO 8);
  DataIntoFIFO_9 <= BinOpOut_55(9 DOWNTO 9);
  DataIntoFIFO_10 <= BinOpOut_55(10 DOWNTO 10);
  DataIntoFIFO_11 <= BinOpOut_55(11 DOWNTO 11);
  DataIntoFIFO_12 <= BinOpOut_55(12 DOWNTO 12);
  DataIntoFIFO_13 <= BinOpOut_55(13 DOWNTO 13);
  S_54 <= to_unsigned(S_75) & to_unsigned(S_74) & to_unsigned(S_73) & to_unsigned(S_72) & to_unsigned(S_71) & 
    to_unsigned(S_70) & to_unsigned(S_69) & to_unsigned(S_68) & to_unsigned(S_67) & to_unsigned(S_66) & 
    to_unsigned(S_65) & to_unsigned(S_64) & to_unsigned(S_63) & to_unsigned(S_62);
  S_61 <= not((to_unsigned(S_55) and not(to_unsigned(S_58))));
  S_60 <= S_59 and S_6;
  S_59 <= not((to_unsigned(S_55) and to_unsigned(S_58)));
  MuxEnables_11 <= to_stdlogic(not(S_56)) & to_stdlogic(S_56);
  S_56 <= S_60 xor AckOut;
  S_55 <= to_stdlogic(S_50 = S_52);
  S_53 <= S_52 + ConstOut;
  S_51 <= S_50 + ConstOut;
  AckOut <= S_2 and S_61;
  swEndPtr_CE <= WireTrue_19 or WireTrue_25;
  MuxEnables_12 <= WireTrue_19 & WireTrue_25;
  localSwEndPtr_CE <= SeqChain_17 or WireTrue_25;
  MuxEnables_13 <= SeqChain_17 & WireTrue_25;
  ...
  MuxEnables_21 <= SeqChain_17 & not(SeqChain_17);
  MuxEnables_22 <= S_4 & S_49;
  S_49 <= not(S_4);
  ...
  BinOpOut_93 <= ConstOut_44 & debugDmaAckWait;
  BinOpOut_92 <= ConstOut_43 & dataDMAProgressCnt_Down & ifc_buf_rellen;
  BinOpOut_91 <= ConstOut_42 & to_unsigned(VCC) & to_unsigned(BUF_NEWLEN_DV) & UNSIGNED(BUF_NEWLEN);
  BinOpOut_90 <= ConstOut_41 & ifc_desc_read & to_unsigned(DESC_EMPTY) & UNSIGNED(DESC_DO);
  BinOpOut_89 <= ConstOut_19 & hwEndPtr;
  BinOpOut_88 <= ConstOut_19 & hwStrPtr;
  ...
  WireTrue_26 <= WireFalse_19 and BinOpOut_87;
  BinOpOut_87 <= to_stdlogic(to_unsigned(SW_RD) = ConstOut);
  RangeCast <= UNSIGNED(SW_DWR);
  BinOpOut_86 <= RangeCast(0 DOWNTO 0);
  RangeCast_1 <= UNSIGNED(SW_DWR);
  BinOpOut_85 <= RangeCast_1(1 DOWNTO 1);
  WireTrue_25 <= LinkWire_3 and BinOpOut_21;
  ...
  BinOpOut_84 <= RangeCast_2(5 DOWNTO 0);
  S_98 <= LinkWire_13 or LinkWire_12 or LinkWire_11 or LinkWire_10 or LinkWire_9 or LinkWire_8 or LinkWire_7 or 
    LinkWire_6_1 or LinkWire_5_1 or LinkWire_4_1 or LinkWire_3_1 or LinkWire_2_1 or LinkWire_1 or LinkWire_0_1 or 
    SwitchOut(0) or (WireFalse_19 and not(BinOpOut_87)) or LinkWire_6 or LinkWire_5 or LinkWire_4 or 
    LinkWire_2 or SwitchOut_1(6) or LinkWire_0 or SwitchOut_1(0) or WireTrue_25 or (LinkWire_3 and not(
    BinOpOut_21));
  WireTrue_24 <= CForkIn_13 and BinOpOut_83;
  WireFalse_19 <= CForkIn_13 and not(BinOpOut_83);
  BinOpOut_83 <= to_stdlogic(to_unsigned(SW_WR) = ConstOut);
  BinOpOut_82 <= to_unsigned(SW_WR) or to_unsigned(SW_RD);
  CForkIn_13 <= StartOut_10 or to_stdlogic(LoopZ_6);
  BinOpOut_81 <= timeoutMonitor + ConstOut_1;
  WireTrue_23 <= WireFalse_17 and to_stdlogic(BinOpOut_80);
  WireFalse_18 <= WireFalse_17 and not(to_stdlogic(BinOpOut_80));
  BinOpOut_80 <= to_unsigned(to_stdlogic(timeoutEnable = ConstOut)) and to_unsigned(to_stdlogic(timeoutExpired = 
    ConstOut));
  S_18 <= WireTrue_23 or WireFalse_18 or WireTrue_22;
  WireTrue_22 <= CForkIn_12 and to_stdlogic(BinOpOut_79);
  WireFalse_17 <= CForkIn_12 and not(to_stdlogic(BinOpOut_79));
  BinOpOut_79 <= to_unsigned(BinOpOut_5) or to_unsigned(BinOpOut_71);
  S_92 <= to_unsigned(to_stdlogic(intrReset = dataDMAProgressCnt_Down_1)) and to_unsigned(to_stdlogic(
    regIntrMonitor >= (intrRegister and ConstOut_39))) and to_unsigned(to_stdlogic(interruptEnable = 
    ConstOut));
  WireTrue_21 <= CForkIn_12 and to_stdlogic(S_92);
  CForkIn_12 <= StartOut_9 or Z_Dones_1_4;
  BinOpOut_78 <= ifc_interrupt1 & ifc_interrupt0;
  CForkIn_11 <= StartOut_8 or Z_Dones_1_2;
  S_17 <= WireTrue_20 or WireFalse_16;
  WireTrue_20 <= CForkIn_10 and BinOpOut_77;
  WireFalse_16 <= CForkIn_10 and not(BinOpOut_77);
  BinOpOut_77 <= to_stdlogic(timeoutMonitor >= timeoutRegister);
  CForkIn_10 <= StartOut_7 or LoopZ_8;
  length_CE <= S_23 or WireTrue_17 or WireFalse_14;
  MuxEnables_31 <= S_23 & WireTrue_17 & WireFalse_14;
  BinOpOut_76 <= (swEndPtr + BinOpOut_75) and bufSizeMask;
  BinOpOut_75 <= ConstOut_38 & length_1;
  WireTrue_19 <= Z_Dones_5 and BinOpOut_74;
  BinOpOut_74 <= to_stdlogic(BinOpOut_65 = dataDMAProgressCnt_Down_1);
  S_16 <= WireTrue_18 or WireFalse_15;
  BinOpOut_73 <= intrMonitor + BinOpOut_72;
  BinOpOut_72 <= ConstOut_19 & BinOpOut_69;
  WireTrue_18 <= S_4 and BinOpOut_71;
  WireFalse_15 <= S_4 and not(BinOpOut_71);
  BinOpOut_71 <= to_stdlogic(intrReset = ConstOut);
  BinOpOut_68 <= length_1 + BinOpOut_67;
  BinOpOut_67 <= dataDMAProgressCnt_Down_1 & BinOpOut_69;
  WireTrue_17 <= S_4 and BinOpOut_66;
  WireFalse_14 <= S_4 and not(BinOpOut_66);
  BinOpOut_66 <= to_stdlogic(BinOpOut_65 = ConstOut);
  BinOpOut_65 <= flag_length(13 DOWNTO 13);
  BinOpOut_70 <= ConstOut_37 & BinOpOut_69;
  BinOpOut_69 <= flag_length(12 DOWNTO 0);
  S_1 <= to_stdlogic(S_2) and to_stdlogic(S_61);
  False_fork_input <= to_stdlogic(S_2) and not(to_stdlogic(S_61));
  S_2 <= to_unsigned(CForkIn_16 and BinOpOut_64) or to_unsigned(S_3);
  BinOpOut_64 <= to_stdlogic(dma_done_cnt /= ConstOut_36);
  S_14 <= WireTrue_19 or (Z_Dones_5 and not(BinOpOut_74)) or (CForkIn_16 and not(BinOpOut_64)) or StartOut_6;
  S_23 <= StartOut_6 or WireTrue_19;
  BinOpOut_63 <= dma_done_cnt - ConstOut_35;
  WireTrue_16 <= WireFalse_13 and BinOpOut_1;
  S_93 <= to_unsigned(BinOpOut_61) and to_unsigned(BinOpOut_58) and to_unsigned(BinOpOut_1);
  WireFalse_13 <= WireFalse_12 and not(to_stdlogic(S_93));
  BinOpOut_61 <= to_stdlogic(RESIZE(UNSIGNED(DMA_TAG), 12) = BinOpOut_60);
  BinOpOut_60 <= ConstOut_33 & BinOpOut_59;
  BinOpOut_59 <= ConstOut_34 or UNSIGNED(DMA_TAG_ID);
  S_94 <= to_unsigned(BinOpOut_61) and to_unsigned(to_stdlogic(dataDMAProgressCnt_Down = dataDMAProgressCnt_Down_1)) and 
    to_unsigned(BinOpOut_58);
  S_15 <= WireTrue_16 or (WireFalse_13 and not(BinOpOut_1)) or (WireFalse_12 and to_stdlogic(S_93)) or 
    WireTrue_15;
  BinOpOut_62 <= dma_done_cnt + ConstOut_35;
  WireTrue_15 <= CForkIn_9 and to_stdlogic(S_94);
  WireFalse_12 <= CForkIn_9 and not(to_stdlogic(S_94));
  BinOpOut_58 <= to_stdlogic(to_unsigned(DMA_DONE) = ConstOut);
  CForkIn_9 <= StartOut_5 or Z_Dones_0;
  descOffset_CE <= WireTrue_8 or SeqChain_17;
  MuxEnables_32 <= WireTrue_8 & SeqChain_17;
  ...
  MuxEnables_35 <= BinOpOut_56 & not(BinOpOut_56);
  S_5 <= to_stdlogic(S_6) and to_stdlogic(S_59);
  False_fork_input_1 <= to_stdlogic(S_6) and not(to_stdlogic(S_59));
  S_6 <= to_unsigned(WireFalse_11) or to_unsigned(S_7);
  BinOpOut_55 <= pageBreakFlag & length;
  BinOpOut_56 <= to_stdlogic(descOffset = ConstOut_17);
  S_13 <= SeqChain_17 or WireTrue_14;
  WireTrue_14 <= CForkIn_15 and BinOpOut_54;
  WireFalse_11 <= CForkIn_15 and not(BinOpOut_54);
  BinOpOut_54 <= to_stdlogic(to_unsigned(DMA_ACK) = dataDMAProgressCnt_Down_1);
  BinOpOut_53 <= (localSwEndPtr + BinOpOut_52) and bufSizeMask;
  BinOpOut_52 <= ConstOut_19 & length;
  BinOpOut_51 <= hwStrPtr + length;
  BinOpOut_50 <= descOffset + RESIZE(length, 12);
  BinOpOut_49 <= length(11 DOWNTO 8);
  BinOpOut_48 <= length(7 DOWNTO 4);
  BinOpOut_47 <= length(3 DOWNTO 0);
  BinOpOut_46 <= laddr(31 DOWNTO 28);
  BinOpOut_45 <= laddr(27 DOWNTO 24);
  BinOpOut_44 <= laddr(23 DOWNTO 20);
  BinOpOut_43 <= laddr(19 DOWNTO 16);
  BinOpOut_42 <= laddr(15 DOWNTO 12);
  BinOpOut_41 <= laddr(11 DOWNTO 8);
  BinOpOut_40 <= laddr(7 DOWNTO 4);
  BinOpOut_39 <= laddr(3 DOWNTO 0);
  BinOpOut_37 <= descOffset(11 DOWNTO 8);
  BinOpOut_36 <= descOffset(7 DOWNTO 4);
  BinOpOut_35 <= descOffset(3 DOWNTO 0);
  S_12 <= (CForkIn_14 and BinOpOut_34) or WireTrue_13 or WireFalse_9;
  WireFalse_10 <= CForkIn_14 and not(BinOpOut_34);
  BinOpOut_34 <= to_stdlogic(newDescReady = dataDMAProgressCnt_Down_1);
  WireTrue_13 <= ElseDone and BinOpOut_33;
  WireFalse_9 <= ElseDone and not(BinOpOut_33);
  BinOpOut_33 <= to_stdlogic(hwDataLength <= pageFreeSpace);
  WireTrue_12 <= SeqChain_20 and BinOpOut_32;
  WireFalse_8 <= SeqChain_20 and not(BinOpOut_32);
  BinOpOut_32 <= to_stdlogic(BinOpOut_31 > swFreeSpace);
  BinOpOut_31 <= ConstOut_19 & hwDataLength;
  S_11 <= WireTrue_11 or WireFalse_7;
  WireTrue_11 <= Z_Dones_4_1 and BinOpOut_30;
  WireFalse_7 <= Z_Dones_4_1 and not(BinOpOut_30);
  BinOpOut_30 <= to_stdlogic(dataLength > ConstOut_18);
  BinOpOut_29 <= ((swStrPtr - localSwEndPtr) - ConstOut_1) and bufSizeMask;
  BinOpOut_28 <= ConstOut_18 - BinOpOut_27;
  BinOpOut_27 <= dataDMAProgressCnt_Down_1 & descOffset;
  BinOpOut_26 <= localHwEndPtr - hwStrPtr;
  BinOpOut_38 <= UNSIGNED(BUFFER_ADDR) + BinOpOut_88;
  WireTrue_10 <= WireFalse_5 and BinOpOut_25;
  WireFalse_6 <= WireFalse_5 and not(BinOpOut_25);
  BinOpOut_25 <= to_stdlogic(hwStrPtr /= localHwEndPtr);
  WireTrue_9 <= CForkIn_8 and to_stdlogic(BinOpOut_24);
  WireFalse_5 <= CForkIn_8 and not(to_stdlogic(BinOpOut_24));
  BinOpOut_24 <= to_unsigned(BinOpOut_57) and to_unsigned(BinOpOut_22);
  CForkIn_8 <= (CForkIn_17 and to_stdlogic(S_95)) or Z_Dones_1_1;
  S_97 <= S_8 or WireTrue_12 or WireFalse_6 or (CForkIn_7 and not(to_stdlogic(BinOpOut_23)));
  S_95 <= to_unsigned(to_stdlogic(pageBreakFlag = ConstOut)) or to_unsigned(BinOpOut_57) or to_unsigned(to_stdlogic(
    controlRegister(0 DOWNTO 0) = ConstOut));
  BinOpOut_57 <= to_stdlogic(controlRegister(1 DOWNTO 1) = ConstOut);
  WireTrue_8 <= CForkIn_7 and to_stdlogic(BinOpOut_23);
  BinOpOut_23 <= to_unsigned(BinOpOut_21) and to_unsigned(BinOpOut_22);
  BinOpOut_22 <= to_stdlogic(pageBreakFlag = dataDMAProgressCnt_Down_1);
  BinOpOut_21 <= to_stdlogic(controlRegister(2 DOWNTO 2) = ConstOut);
  CForkIn_7 <= (CForkIn_17 and not(to_stdlogic(S_95))) or Z_Dones_4 or StartOut_4;
  BinOpOut_20 <= ConstOut_3 & BinOpOut_59;
  BinOpOut_19 <= BinOpOut_20(15 DOWNTO 12);
  BinOpOut_18 <= BinOpOut_20(11 DOWNTO 8);
  BinOpOut_17 <= BinOpOut_20(7 DOWNTO 4);
  BinOpOut_16 <= BinOpOut_20(3 DOWNTO 0);
  ...
  BinOpOut_4 <= dataDMAProgressCnt - ConstOut_34;
  WireTrue_1 <= WireFalse_1 and BinOpOut_1;
  BinOpOut_3 <= dataDMAProgressCnt + ConstOut_34;
  ...
  S_122 <= to_unsigned(S_110) or to_unsigned(S_104) or to_unsigned(SeqChain_6) or to_unsigned(WireFalse_10);
  S_114 <= to_unsigned(S_104) or to_unsigned(SeqChain_6) or to_unsigned(WireFalse_10);
  S_109 <= to_unsigned(S_103) or to_unsigned(SeqChain_7) or to_unsigned(WireFalse_10);
  S_106 <= to_unsigned(SeqChain_6) or to_unsigned(WireFalse_10);
  S_102 <= to_unsigned(SeqChain_1) or to_unsigned(StartOut_4);
  S_96 <= to_unsigned(S_115) or to_unsigned(S_101) or to_unsigned(StartOut_4) or to_unsigned(WireTrue_7) or 
    to_unsigned(S_107) or to_unsigned(S_99) or to_unsigned(SeqChain_6) or to_unsigned(WireFalse_10);
  S_37 <= S_31(0 DOWNTO 0);
  S_38 <= S_31(1 DOWNTO 1);
  S_39 <= S_31(2 DOWNTO 2);
  S_40 <= S_31(3 DOWNTO 3);
  BinOpOut_0 <= BinOpOut_94(0 DOWNTO 0);
  BinOpOut_1_1 <= BinOpOut_94(1 DOWNTO 1);
  BinOpOut_2_1 <= BinOpOut_94(2 DOWNTO 2);
  BinOpOut_3_1 <= BinOpOut_94(3 DOWNTO 3);
  BinOpOut_4_1 <= BinOpOut_94(4 DOWNTO 4);
  S_0 <= to_unsigned(S_44) & to_unsigned(S_43) & to_unsigned(S_42) & to_unsigned(S_41);
  ...
  MuxEnables_41 <= WireTrue_7 & StartOut_4 & SeqChain_1 & SeqChain_2 & SeqChain_3 & SeqChain_4 & WireFalse_10 & 
    SeqChain_6 & SeqChain_7 & SeqChain_8 & SeqChain_10 & SeqChain_11 & SeqChain_12 & SeqChain_13 & SeqChain_14 & 
    SeqChain_15 & SeqChain_16 & SeqChain_9 & SeqChain_18 & SeqChain_19;
  MuxEnables_42 <= WireTrue_7 & StartOut_4 & SeqChain_1 & SeqChain_2 & SeqChain_3 & SeqChain_4 & WireFalse_10 & 
    SeqChain_6 & SeqChain_7 & SeqChain_8 & SeqChain_10 & SeqChain_11 & SeqChain_12 & SeqChain_13 & SeqChain_14 & 
    SeqChain_15 & SeqChain_16 & SeqChain_9 & SeqChain_18 & SeqChain_19;
  ...
  I0_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I0_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I0_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I1_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I1_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I1_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I2_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I2_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I2_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I3_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I3_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I3_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I4_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I4_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I4_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I5_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I5_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I5_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I6_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I6_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I6_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I7_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I7_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I7_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I8_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I8_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I8_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I9_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I9_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I9_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I10_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I10_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I10_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I11_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I11_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I11_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I12_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I12_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I12_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  I13_FIFORam_rx_dma_ctrl_opt_162_A0 <= to_stdlogic(S_50);
  ...
  I13_FIFORam_rx_dma_ctrl_opt_162_DPRA0 <= to_stdlogic(S_52);
  ...
  I13_FIFORam_rx_dma_ctrl_opt_162_WE <= to_stdlogic(S_60);
  ...
  I0_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_40);
  ...
  I0_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_96);
  ...
  I1_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_39);
  ...
  I1_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_96);
  ...
  I2_DMAReqMem_rx_dma_ctrl_opt_208_A4_BinOpOut_4 <= to_stdlogic(BinOpOut_4_1);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_38);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_32);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_33);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_34);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3 <= to_stdlogic(S_35);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA4 <= to_stdlogic(S_36);
  I2_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_96);
  ...
  I3_DMAReqMem_rx_dma_ctrl_opt_208_A4_BinOpOut_4 <= to_stdlogic(BinOpOut_4_1);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_D <= to_stdlogic(S_37);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA0 <= to_stdlogic(S_32);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA1 <= to_stdlogic(S_33);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA2 <= to_stdlogic(S_34);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA3 <= to_stdlogic(S_35);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA4 <= to_stdlogic(S_36);
  I3_DMAReqMem_rx_dma_ctrl_opt_208_WE <= to_stdlogic(S_96);
  ...
  I0_DMAReqMem_rx_dma_ctrl_opt_208 : RAM32X1D
    GENERIC MAP (
      INIT => X"00000000"
    )
    PORT MAP (
  ...
  -- MPRAM component instance 'DMAReqMem'
  I1_DMAReqMem_rx_dma_ctrl_opt_208 : RAM32X1D
    GENERIC MAP (
      INIT => X"00000000"
    )
    PORT MAP (
  ...
  -- MPRAM component instance 'DMAReqMem'
  I2_DMAReqMem_rx_dma_ctrl_opt_208 : RAM32X1D
    GENERIC MAP (
      INIT => X"00000000"
    )
    PORT MAP (
      ...
      A4 => I2_DMAReqMem_rx_dma_ctrl_opt_208_A4_BinOpOut_4,
      ...
      DPRA4 => I2_DMAReqMem_rx_dma_ctrl_opt_208_DPRA4,
      SPO => S_46,
      WCLK => PIN_CLK,
  ...
  -- MPRAM component instance 'DMAReqMem'
  I3_DMAReqMem_rx_dma_ctrl_opt_208 : RAM32X1D
    GENERIC MAP (
      INIT => X"00000000"
    )
    PORT MAP (
      ...
      A4 => I3_DMAReqMem_rx_dma_ctrl_opt_208_A4_BinOpOut_4,
      ...
      DPRA4 => I3_DMAReqMem_rx_dma_ctrl_opt_208_DPRA4,
      SPO => S_45,
      WCLK => PIN_CLK,
