...
-- \   \   \/     Version: K.39
--  \   \         Application: netgen
--  /   /         Filename: asfifo_rd_addr.vhd
-- /___/   /\     Timestamp: Wed Dec  3 20:52:31 2008
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -w -sim -ofmt vhdl /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_rd_addr.ngc /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_rd_addr.vhd 
-- Device	: 5vlx110tff1136-1
-- Input file	: /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_rd_addr.ngc
-- Output file	: /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_rd_addr.vhd
-- # of Entities	: 1
-- Design Name	: asfifo_rd_addr
...
architecture STRUCTURE of asfifo_rd_addr is
  signal NlwRenamedSig_OI_empty : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_56 : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_wr_rst_fb_55 : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_rd_rst_fb_54 : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_rd_rst_reg_53 : STD_LOGIC; 
  ...
  signal din_2 : STD_LOGIC_VECTOR ( 21 downto 0 ); 
  signal dout_3 : STD_LOGIC_VECTOR ( 21 downto 0 ); 
...
begin
  ...
  BU2_U0_gbiv5_bi_fblk_gextw_1_inst_extd_gonep_inst_prim_gw36_sngfifo18 : FIFO18_36
    ...
    port map (
      RDEN => rd_en,
      WREN => wr_en,
      RST => BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_56,
      RDCLK => rd_clk,
      WRCLK => wr_clk,
  ...
  BU2_U0_gbiv5_bi_rstbt_rd_rst_reg : FDPE
    ...
    port map (
      C => rd_clk,
      CE => BU2_U0_gbiv5_bi_rstbt_rd_rst_fb_54,
      D => BU2_rd_data_count(0),
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_rd_rst_reg_53
    );
  BU2_U0_gbiv5_bi_rstbt_wr_rst_fb : FDP
    ...
    port map (
      C => wr_clk,
      D => BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_56,
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_wr_rst_fb_55
    );
  BU2_U0_gbiv5_bi_rstbt_wr_rst_reg : FDPE
    ...
    port map (
      C => wr_clk,
      CE => BU2_U0_gbiv5_bi_rstbt_wr_rst_fb_55,
      D => BU2_rd_data_count(0),
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_56
    );
  BU2_U0_gbiv5_bi_rstbt_rd_rst_fb : FDP
    ...
    port map (
      C => rd_clk,
      D => BU2_U0_gbiv5_bi_rstbt_rd_rst_reg_53,
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_rd_rst_fb_54
    );
  BU2_XST_GND : GND
    port map (
