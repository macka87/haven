...
-- \   \   \/     Version: K.39
--  \   \         Application: netgen
--  /   /         Filename: asfifo_data_out.vhd
-- /___/   /\     Timestamp: Wed Dec  3 21:41:15 2008
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -w -sim -ofmt vhdl /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_data_out.ngc /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_data_out.vhd 
-- Device	: 5vlx110tff1136-1
-- Input file	: /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_data_out.ngc
-- Output file	: /home/local/kajan/xilinx_fifo/tmp/_cg/asfifo_data_out.vhd
-- # of Entities	: 1
-- Design Name	: asfifo_data_out
...
architecture STRUCTURE of asfifo_data_out is
  signal NlwRenamedSig_OI_empty : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_44 : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_wr_rst_fb_43 : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_rd_rst_fb_42 : STD_LOGIC; 
  signal BU2_U0_gbiv5_bi_rstbt_rd_rst_reg_41 : STD_LOGIC; 
...
begin
  ...
  BU2_U0_gbiv5_bi_fblk_gextw_1_inst_extd_gonep_inst_prim_gw36_sngfifo18 : FIFO18_36
    ...
    port map (
      RDEN => rd_en,
      WREN => wr_en,
      RST => BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_44,
      RDCLK => rd_clk,
      WRCLK => wr_clk,
  ...
  BU2_U0_gbiv5_bi_rstbt_rd_rst_reg : FDPE
    ...
    port map (
      C => rd_clk,
      CE => BU2_U0_gbiv5_bi_rstbt_rd_rst_fb_42,
      D => BU2_rd_data_count(0),
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_rd_rst_reg_41
    );
  BU2_U0_gbiv5_bi_rstbt_wr_rst_fb : FDP
    ...
    port map (
      C => wr_clk,
      D => BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_44,
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_wr_rst_fb_43
    );
  BU2_U0_gbiv5_bi_rstbt_wr_rst_reg : FDPE
    ...
    port map (
      C => wr_clk,
      CE => BU2_U0_gbiv5_bi_rstbt_wr_rst_fb_43,
      D => BU2_rd_data_count(0),
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_wr_rst_reg_44
    );
  BU2_U0_gbiv5_bi_rstbt_rd_rst_fb : FDP
    ...
    port map (
      C => rd_clk,
      D => BU2_U0_gbiv5_bi_rstbt_rd_rst_reg_41,
      PRE => rst,
      Q => BU2_U0_gbiv5_bi_rstbt_rd_rst_fb_42
    );
  BU2_XST_GND : GND
    port map (
