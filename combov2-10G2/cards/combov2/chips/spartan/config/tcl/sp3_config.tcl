# 
# Project automation script for sp3_config 
# 
# Created for ISE version 10.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source sp3_config.tcl, then you can
...
set myProject "sp3_config.ise"
set myScript "sp3_config.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../src/clk_generator.vhd"
   xfile add "../src/sp3_config_top.ucf"
   xfile add "../src/sp3_config_top.vhd"
   xfile add "../tb/flash_mem.vhd"
   xfile add "../tb/tb_sp3_config_top.vhd"
   xfile add "../tb/virtex5.vhd"

   # Set the Top Module as well...
   project set top "behavioral" "sp3_config_top"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "sp3_config_top_guide.ncd"
